...
def make_map(config):
    ...
    map.connect('photo', '/Photo-Gallery-1/{title}', controller='news', action='old_photo')
    map.connect('photo2', '/Photo-Gallery-2/{title}', controller='news', action='new_photo')
    map.connect('photo3', '/Photo-Gallery-3/{title}', controller='news', action='photo3')
