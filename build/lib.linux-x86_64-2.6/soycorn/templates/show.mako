...
<ul id="sddm">
	...
	<li><a href="${c.location}Photo-Gallery/1">Photo Gallery</a></li>
    <li><a onmouseover="mopen('m3')" onmouseout="mclosetime()">Brazilian Biofuels</a>
...
<%def name="javapics()">
	<script type="text/javascript">
		...
		var used = new Array()
		function getRand(){
			var n = Math.floor(Math.random() * 125) + 75;
			var i;
			for (i = 0; i < used.length; i ++){
				while (n == used[i]){
					n = Math.floor(Math.random() * 125) + 75;
				}
			}
			var str = "";
			if (n < 100)
